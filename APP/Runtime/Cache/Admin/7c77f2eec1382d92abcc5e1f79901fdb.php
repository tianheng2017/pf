...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        <ul class="breadcrumb">
            ...
            <li class="text-muted">商品管理 /  商品详情</li>
            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/Admin/User/shopinfo/id/77.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" name="name" class="form-control input" value="<?php echo ($info["name"]); ?>" readonly="readonly" />
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">商品价格：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="price" readonly="readonly" value="<?php echo ($info["price"]); ?>" />
                                                </div>
                                            </div>

                                            <div class="form-group item_title ">
                                                <label class="left control-label">商品图片地址：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="wx_no"  readonly="readonly" value="<?php echo ($info["img"]); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">商品图片：</label>
                                                <div class="right">
                                                    <img src="<?php echo ($info["img"]); ?>" style="width:10%"/>
                                                </div>
                                            </div>

                                            <div class="form-group item_title ">
                                                <label class="left control-label">创建时间：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="mobile" readonly="readonly" value="<?php echo ($info["addtime"]); ?>" />
                                                </div>
                                            </div>
                                        <div class="form-group"></div>
