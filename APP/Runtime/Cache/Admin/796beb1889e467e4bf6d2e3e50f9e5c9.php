...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            ...
            <li class="text-muted"><?php echo $_menu_tab['name']['0'] .'/'.'商品管理';?></li>
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-size:12px;text-align: center;">商品名称</th>
                                                    <th style="font-size:12px;text-align: center;">商品价格</th>
                                                    <th style="font-size:12px;text-align: center;">商品图片</th>
                                                    <th style="font-size:12px;text-align: center;">创建时间</th>
                                                    <th style="max-width:20%;font-size:12px;text-align: center;" >操作</th>
                                                </tr>
                                            </thead>
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
															<td style="font-size:12px;text-align: center;"><?php echo $v['id'];?></td>
															<td style="font-size:12px;text-align: center;"><?php echo $v['name'];?></td>
															<td style="font-size:12px;text-align: center;"><?php echo $v['price']?></td>
															<td style="font-size:12px;text-align: center;"><img src="<?php echo $v['img']?>" style="width: 110px;height: 110px"/></td>
															<td style="font-size:12px;text-align: center;"><?php echo date('Y-m-d H:i',$v['addtime']);?></td>
															
															<td style="font-size:12px;text-align: center;">
																<a href="<?php echo U('User/shopedit',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">编辑 ||</a>
																<a href="<?php echo U('User/delshop',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">删除</a>
															</td>
