...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            ...
            <li class="text-muted">系统 / 抢单管理 / 全部订单列表</li>
                                    ...
                                    <form class="form" method="get" action="">
                                        <div class="form-group">
                                            <div class="input-group search-form">
                                                <input type="text" name="keyword" class="search-input form-control" value="<?php echo ($_GET["keyword"]); ?>" placeholder="请输入金额/收款类型输入-1表示微信、-2支付宝、-3银行">
                                                    ...
                                                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td>
															   ...
															   <?php }elseif($data['status'] == 2){?>
																	<span style="color:#3cd7d1">匹配成功</span>
															   <?php }elseif($data['status'] == 3){?>
																	<span style="color:#00b431">支付成功</span>
															   <?php }elseif($data['status'] == 4){?>
																	<span style="color:#ff354f">未支付</span>
															   <?php }elseif($data['status'] == 5){?>
																	<span style="color:#890f0f">匹配失败</span>
															   <?php }?>
                                                            </td>
